...
PROTOCOL_SHA256 = "161175f602e241f1fd87bb2455132c6d7faf0e1e3487fc0e1d728823aecc8b7b"
...
def assemble(ctx, answers):
    ...
    return {"kind": "local-evidence-decisions-experiment", "schema_version": 25, "release_cleared": False,
...
class ProviderReviewDecisionsV25(gl.contract.Contract):
    state: str
    ...
    def __init__(self, evidence_json: str):
        ...
        self.state = canonical({"version": 25, "kind": "provider-review-decisions-candidate",
