...
- `/api/catalog/check`: same-origin read-only POST for one of the eight server-catalog providers; returns page availability, timestamp and hash, not semantic verification. Caller-supplied URLs remain rejected.
