...
const files=[
  ...
  ...["compare.html","compare.js","compare-model.js","comparison-report.js","compare.css","service-catalog.json","wallet-connect.js","wallet-connection.js","wallet-session.js"].map(p=>["ui/"+p,"public/"+p]),
